...
use base qw(LWP::UserAgent LWP::UserAgent::ProxifyBase);

# YES! That's all! What? Did you expect lots of codes in here?!
# To be serious LWP::UserAgent::ProxifyBase contents were ment to be
# in here, but I decided that releasing it as base class would be more
# useful, as for this module. Well, I just like the use
# LWP::UserAgent::Proxify better... cheers
...
LWP::UserAgent::Proxify - LWP::UserAgent with proxi-hopping
...
=head1 SYNOPSIS
    ...
    use LWP::UserAgent::Proxify;

    my $ua = LWP::UserAgent::Proxify->new( agent => 'fox', timeout => 10 );
...
All the methods LWP::UserAgent::Proxify are prefixed with C<proxify_>.
...
Please report any bugs or feature requests to C<bug-lwp-useragent-proxify at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=LWP-UserAgent-Proxify>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=LWP-UserAgent-Proxify>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/LWP-UserAgent-Proxify>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/LWP-UserAgent-Proxify>

=item * Search CPAN

L<http://search.cpan.org/dist/LWP-UserAgent-Proxify>
